...
class Forecaster(nn.Module):
    def __init__(self, subnets, rnns):
        ...
        self.blocks = len(subnets)
        #self.conv3d = nn.Conv3d(in_channels=5, out_channels=5, kernel_size=3, stride=1, padding=1)
...
conv2d_params = OrderedDict({
    'conv1_relu_1': [21, 64, 7, 5, 1],
    'conv2_relu_1': [64, 192, 5, 3, 1],
    'conv3_relu_1': [192, 192, 3, 2, 1],
    'deconv1_relu_1': [192, 192, 3, 2, 1],
    'deconv2_relu_1': [192, 64, 5, 3, 1],
    'deconv3_relu_1': [64, 64, 8, 5, 1],
