...
def main_test(modelType, clsLoss=False):
    ...
    raw_arr = gdal.Open('/home/zlx/NTL/gn_attention/Products/China1992.tif')
    im_geotrans = raw_arr.GetGeoTransform()
    im_proj = raw_arr.GetProjection()
    input_year = range(2008, 1984, -1)
    all_arr = []
    crop_size = 512
    ...
    for i in input_year:
        input_name = '/home/zlx/NTL/gn_attention/all_ntl/China_'+str(i)+'.tif'
    ...
    for y in range(13):
        ...
        filename = './output/China_' + str(1983-y)+'.tif'
        #pdb.set_trace()
